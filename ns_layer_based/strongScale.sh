...
./multi_ns_parallel -p ns_01 -t FATAL -f -n 20 1
./multi_ns_parallel -p ns_01 -t FATAL -f -n 24 1
./multi_ns_parallel -p ns_01 -t FATAL -f -n 36 1
./multi_ns_parallel -p ns_01 -t FATAL -f -n 64 1
./multi_ns_parallel -p ns_01 -t FATAL -f -n 128 1
./multi_ns_parallel -p ns_01 -t FATAL -f -n 256 1
